...
export function validateStep(
  ...
  } else if (!EMAIL_REGEX.test(state.agreement.financierSignatory.email.trim())) {
  ...
  if (!state.agreement.financierSignatory.mobile.trim()) {
    errors.financierSignatory_mobile =
      "Financier signatory mobile is required";
  } else if (!PHONE_REGEX.test(state.agreement.financierSignatory.mobile.trim())) {
    errors.financierSignatory_mobile =
  ...
  if (!state.agreement.itarangSignatory1.email.trim()) {
    errors.itarangSignatory1_email =
      "iTarang signatory 1 email is required";
